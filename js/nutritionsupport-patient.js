/* =========================================================
   ...
   Refactor of the WORKING original page.

   - Calculation logic preserved.
   - Patient/support-day workflow preserved.
   - Supabase client comes from js/auth-access.js.
   - Normal script intentionally retained for inline HTML handlers.
   ========================================================= */
