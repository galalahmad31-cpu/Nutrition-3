...
if (!access || !supabaseClient) {
  console.error('Diet Planner Core is not available. Check that Core files are loaded before this page script.');
  document.addEventListener('DOMContentLoaded',()=>{
    const notice=document.createElement('div');
    notice.style.cssText='padding:16px;text-align:center;color:#b91c1c;font-family:Cairo,sans-serif';
    notice.textContent='تعذر تشغيل نظام الاتصال بالتطبيق. تأكد من تحميل ملفات Core.';
