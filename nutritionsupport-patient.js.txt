 ...
 * Extracted from the HTML page. UI/CSS remain in the HTML.
 * Single Supabase client + single application script.
 */
...
/* =========================================================
    ...
    const initializeNutritionSupportUI = () => {
...
document.readyState === 'loading'
    ? document.addEventListener('DOMContentLoaded', initializeNutritionSupportUI, { once: true })
    : initializeNutritionSupportUI();

/* =========================================================
   SUPABASE + PATIENT / SUPPORT-DAY DATA
   ========================================================= */
const supabase = window.supabase.createClient('https://zwxnmnfoknfbzvptnpmv.supabase.co','sb_publishable_A6u5kWAdL60bYpz1wRyv6w_J2p896iY');
...
/* Public handlers used by existing inline HTML controls. */
window.addIVLine = addIVLine;
window.removeIVLine = removeIVLine;
window.calculateBreastmilkFortification = calculateBreastmilkFortification;
window.toggleQuickAccordion = toggleQuickAccordion;
window.toggleENAccordion = toggleENAccordion;
window.togglePatientHeader = togglePatientHeader;
window.toggleGlucoseInputMode = toggleGlucoseInputMode;
window.toggleGlucoseMode = toggleGlucoseMode;
window.toggleTpnTypeMode = toggleTpnTypeMode;
window.toggleDexMode = toggleDexMode;
window.convertDensityToKcalPerMl = convertDensityToKcalPerMl;
window.convertKcalPerMlToUnit = convertKcalPerMlToUnit;
window.calculateFormulaConcentration = calculateFormulaConcentration;
window.calculateCalorieBased = calculateCalorieBased;
window.switchTab = switchTab;
window.switchSubTab = switchSubTab;
window.switchEnNested = switchEnNested;
window.switchPnNested = switchPnNested;
window.toggleFortifier = toggleFortifier;
window.calculateEN = calculateEN;
window.calculateTPN = calculateTPN;
window.calculateQuickGIR = calculateQuickGIR;
window.calculateDextrosePrep = calculateDextrosePrep;
window.loadPrintSettings = loadPrintSettings;
window.savePrintSettings = savePrintSettings;
window.showPrintCompletion = showPrintCompletion;
window.closePrintCompletion = closePrintCompletion;
window.smartPrint = smartPrint;
window.closePrintSettings = closePrintSettings;
window.confirmSupportPrint = confirmSupportPrint;
window.shareText = shareText;
window.shareVolumeSummary = shareVolumeSummary;
window.shareCaloriesSummary = shareCaloriesSummary;
window.shareTPN = shareTPN;
window.smartShare = smartShare;
window.copyToClipboard = copyToClipboard;
window.runMixing = runMixing;
window.dayControls = dayControls;
window.activeSupportTab = activeSupportTab;
window.captureDayState = captureDayState;
window.restoreDayState = restoreDayState;
window.setDayEditMode = setDayEditMode;
window.formatDayDate = formatDayDate;
window.renderSupportDays = renderSupportDays;
window.showDeleteConfirm = showDeleteConfirm;
window.deleteSupportDay = deleteSupportDay;
window.saveCurrentSupportDay = saveCurrentSupportDay;
window.selectSupportDay = selectSupportDay;
window.addSupportDay = addSupportDay;
window.initSupportDays = initSupportDays;
